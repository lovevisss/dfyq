    ...
    <div class="content_box clearfix">
        ...
        <div class="left_area fl">
            ...
            <div class="form_body">
                ...
                {{Form::text('student_num', null, ['placeholder' => '学号', 'class' => 'form-control'])}}
                {!!$errors->first('student_num', '<span class="help-block">:message</span>')!!}
        ...
        <div class="right_area fl">
            <h5>已有账号:</h5>
            <a href="{{route('student_login')}}" class="login_now">直接登录 <i class="glyphicon glyphicon-log-in"></i></a>
        </div>
    </div>
@endsection
